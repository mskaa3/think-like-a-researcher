...
This repository provides the data for our paper on LLM-based scientific ideation. It contains the dataset for training and alignment, built from structured literature-derived concept connections, together with the evaluation data used to assess the novelty and grounding of generated hypotheses.

# Think Like a Researcher: A Dataset for Scientific Ideation with Large Language Models
**Authors:** Julia Moska, Maciej Piasecki, Arkadiusz Janz

**Affiliation:** Department of Artificial Intelligence, Wrocław University of Science and Technology
